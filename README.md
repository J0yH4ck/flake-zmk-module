...
The .uf2 file with tab "left" is for the left hand keyboard, and the lable "right" is for the right hand keyboard. Just drag the file to the document. Once the document dispear, the firmware is done.
